...
function Cart() {
    ...
    return (
        ...
        <div className="w-8/12 flex-column justify-end">
        
        <div className="flex flex-row justify-end mt-8">
        <h2 className="text-center text-3xl text-candlelight-500 font-bold mt-8 mb-8 ml-44">Votre panier contient {meubles.length} articles:</h2>
        <ClearCartButton />
        </div>
        ...
        <div className="w-3/4 flex flex-col p-4 ml-40" key={meuble.id}>
            ...
            <div className="w-4/12 p-4 flex flex-col mt-28">
            <div className="bg-white p-4 rounded-md mb-4 border-2 border-violet-400 shadow-lg sticky top-48">
