        ...
        <footer className="bg-white mt-20 w-full grow-0 sticky">
            <div className="flex flex-row justify-around bg-zinc-50">
                ...
                <div>
                    ...
                    <ul className="text-violet-300">
                        ...
                        <li className="mb-2">
                            <a href="#" className="dark:hover:text-violet-700">Contact Us</a>
                        </li>
                    </ul>
                </div>
                <div>
                    <h2 className="mb-3 text-sm font-semibold text-violet-300 uppercase ">Legal</h2>
                    <ul className="text-violet-300">
                        <li className="mb-2">
                ...
                <div>
                    <h2 className="mb-3 text-sm font-semibold text-violet-300 uppercase">Download</h2>
                    <ul className="text-violet-300 ">
                        <li className="mb-2">
                            <a href="#" className="dark:hover:text-violet-700">iOS</a>
                        </li>
                        <li className="mb-2">
            ...
            <div className="px-2 py-3 bg-gray-100 ">
                ...
                <div className="flex mt-4 space-x-6 sm:justify-center md:mt-0">
                    <a href="#" className="text-violet-300 dark:hover:text-violet-700">
                    ...
                    <a href="#https://www.instagram.com/adatechschool/?hl=fr" className="text-violet-300 dark:hover:text-violet-700">
