...
function Footer() {
    return (
        <footer className=" ">
            <div className="w-full flex flex-row sm:space-x-40 space-x-8 py-2 bg-zinc-50 justify-center text-center text-sm">
                <div className='flex flex-col space-y-1' >
                    <h2 className="mb-1 font-bold text-violet-300 uppercase ">Company</h2>
                    <ul className="text-violet-300">
                        <li >
                            <a href="/about" className=" hover:text-violet-700">About</a>
                        </li>
                        <li >
                            <a href="#" className="hover:text-violet-700">Blog</a>
                        </li>
                        <li >
                            <a href="#" className="hover:text-violet-700">Contact Us</a>
                        </li>
                    </ul>
                </div>
                <div  className='flex flex-col space-y-1'>
                    <h2 className="mb-1 font-semibold text-violet-300 uppercase ">Legal</h2>
                    <ul className="text-violet-300">
                        <li >
                            <a href="#" className="hover:text-violet-700">Privacy Policy</a>
                        </li>
                        <li >
                            <a href="#" className="hover:text-violet-700">Terms &amp; Conditions</a>
                        </li>
                    </ul>
                </div>
                <div  className='flex flex-col space-y-1 '>
                    <h2 className="mb-1 font-semibold text-violet-300 uppercase">Download</h2>
                    <ul className="text-violet-300 ">
                        <li className="mb-1">
                            <a href="#" className="hover:text-violet-700">iOS</a>
                        </li>
                        <li className="mb-1">
                            <a href="#" className="hover:text-violet-700">Android</a>
                        </li>
                    </ul>
                </div>
            </div>
            <div className="px-2 py-3 bg-gray-100 ">
                ...
                <div className="flex flex-row space-x-6 justify-center">
                    <a href="#" className="text-violet-300 hover:text-violet-700">
                    ...
                    <a href="#https://www.instagram.com/adatechschool/?hl=fr" className="text-violet-300 hover:text-violet-700">
