...
function ClearCartButton() {
    const clearStorage = () => {
        ...
        return (
            <button onClick={clearStorage} className="font-bold tracking-wide text-white bg-violet-400 transition-all duration-500 hover:bg-violet-700 focus:outline-none rounded-lg text-center sm:my-6 sm:mr-10 p-2 sm:p-4" alt="bouton du caddie">
