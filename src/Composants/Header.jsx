    ...
    return(
        <div className = "bg-white flex flex-row justify-evenly shadow-md sticky w-full top-0 z-10">
            ...
            <div className='flex flex-row items-center mt-4 gap-4'>
                <a href="/MonCompte">
                <button type="submit" className="mb-6 text-white bg-violet-400 transition-all duration-1000 hover:bg-violet-700 focus:outline-none font-medium rounded-lg text-sm sm:w-auto px-5 py-2.5 text-center">Mon Compte</button>
                </a>
                <BtnCart/>
            </div>
        </div>
